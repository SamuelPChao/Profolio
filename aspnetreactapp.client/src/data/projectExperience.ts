  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        title: "深色模式",
        description:
          "使用Tailwind變數設置深色模式, 並透過localStorage存儲使用者設置, 提供使用者切換深色模式功能, 並提供使用者設置儲存功能, 使使用者下次登入時保持設置。",
      },
    ],
    ...
    imgSources: [
      ...
      "https://imgur.com/SjehhVH",
      "https://imgur.com/aX300PM",
      "https://imgur.com/NUIwsx5",
      "https://imgur.com/Mzc5oSS",
      "https://imgur.com/KYNMmg9",
      "https://imgur.com/t7vzmVW",
      "https://imgur.com/hoqkbjo",
      "https://imgur.com/s68butv",
      "https://imgur.com/aEXO9vT",
      "https://imgur.com/fiFhuef",
      "https://imgur.com/PKSCbQg",
      "https://imgur.com/IHeZeRw",
      "https://imgur.com/yRNyrMC",
      "https://imgur.com/i1nVpCt",
      "https://imgur.com/eBb7vYI",
    ],
  },
];
